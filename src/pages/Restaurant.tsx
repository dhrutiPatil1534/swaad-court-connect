...
export default function Restaurant() {
  ...
  const categories = ['All', 'Burgers', 'Sides', 'Beverages'];
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  <h1 className="text-2xl font-heading font-bold">{mockRestaurant.name}</h1>
                ...
                <p className="text-muted-foreground mb-3">{mockRestaurant.description}</p>
                
                <div className="flex items-center gap-4 text-sm mb-3">
                  <div className="flex items-center gap-1">
                    <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
                    <span className="font-medium">{mockRestaurant.rating}</span>
                    <span className="text-muted-foreground">({mockRestaurant.totalRatings})</span>
                  </div>
                  <div className="flex items-center gap-1">
